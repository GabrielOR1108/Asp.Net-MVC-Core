...
namespace InfoWinDev.UI.Controllers
{
    ...
    public class ProdutosController : Controller
    {
        ...
        private readonly InfoWinDevDataContext _ctx;

        public ProdutosController(InfoWinDevDataContext ctx)
        {
            _ctx = ctx;
        }
        ...
        {
            var tipos = _ctx.TipoProdutos.ToList().Select(t => new SelectListItem {Value = t.Id.ToString(), Text = t.Nome });
            ViewBag.Tipos = tipos;
